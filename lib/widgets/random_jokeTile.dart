...
class random_jokeTile extends StatefulWidget {
  const random_jokeTile({Key key}) : super(key: key);

  @override
  _random_jokeTileState createState() => _random_jokeTileState();
}

class _random_jokeTileState extends State<random_jokeTile> {
